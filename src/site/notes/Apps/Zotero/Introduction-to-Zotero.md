...
![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724402.png)
...
![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724403%201.png)

#### 在網頁上做筆記

文章以網頁快照的方式存下後，同樣可以直接在上面註記
![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724404.png)

可以放大縮小！
![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724405.gif)
...
![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724407%201.png)

左邊是下載對應作業系統的版本，右邊是瀏覽器插件。兩個都裝可以讓 Zotero 發揮最強大的能力！
![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724408.png)
{ #16bc83}
...
1. 點擊左上角 `Add/Edit Citation`
   ![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724415.png)
2. 選擇要引用的文獻，可以複選，選好後按 `Enter`
   ![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724416.png)
3. 成功引用
   ![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724416%201.png)
4. 點選「參考文獻」的位置後，再點選選單中的 `Add/Edit Bibliography` (在剛剛`Add/Edit Citation` 的右邊)
   ![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724418.png)
   就會自動把參考資料依照設定好的格式填上：
   ![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724419.png)
...
回到 Overleaf 貼上：
![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724422.png)

### 5. 匯出檔案

`右鍵 ->  Show in Finder` (MacOS) 可以查看原始檔案存放的位置。
![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724423.png)
![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724423%201.png)
這是匯入文獻當下Zotero自己產生的副本。點開會發現上面並沒有註記，這是因為Zotero並不會直接去更改原始檔。若想與他人分享筆記，請回到 Zotero 點選想匯出的 PDF，並選擇 `File -> Export PDF...`
![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724424.png)

就可以匯出帶有註記的 PDF 檔並分享檔案給他人。
![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724425.png)
...
1. 進入GitHub頁面後點擊 `Releases` (紅框處)
   ![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724429.png)
2. 找到後綴 `.xpi` 的檔案並下載。如果使用 Firefox 瀏覽器，需要 `右鍵 -> Save Link As...`
   ![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724430.png)
3. 回到 Zotero，點選 `Tools -> Plugins`
   ![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724431.png)
4. 在右上角的齒輪中選 `Install Plugin From File...`
   ![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724431%201.png)
5. 選擇剛剛的 `.xpi` 檔就會安裝
...
- 若想使用自己的API key用ChatGPT來翻譯，請去Zotero 的設定 (MacOS 快捷鍵 `command` + `,`) 輸入 key
  ![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724433.png)
...
- 如果有使用 Obsidian 來做筆記的話，經過設定可以做到
	- 從 Zotero 中建立筆記至 Obsidian
	  ![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724436.gif)
	- 將 Zotero 中的註記直接拖入 Obsidian 中
	  ![](/img/user/Apps/Zotero/Attachments/Introduction-to-Zotero/file-20260221145724437.gif)
- 請參考插件作者寫的[文件](https://zotlit.aidenlx.top/)來設定

同步更新於： https://arc13tangent.github.io/Intro-to-Zotero/
